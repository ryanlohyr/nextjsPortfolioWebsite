				...
				{blogs.map(blog => {
					return (
						<div
							onClick={() => {}}
							key={blog.title}
							className="border hover:rounded-[8px] border-transparent dark:hover:border-gray-300 hover:border-gray-900 transition-all duration-300 w-[85%]  sm:w-4/5 md:w-2/5 flex justify-center text-start flex-col"
						>
